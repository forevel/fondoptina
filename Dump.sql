...
INSERT INTO `menu` VALUES (1,'Спорт',0,NULL,2),(2,'Партнёры',0,NULL,3),(3,'Отчётность',0,NULL,4),(5,'Главная',0,'index.php',0),(6,'Проекты',0,'projects.php',1),(8,'Контакты',0,'contacts.php',5),(9,'Православная гимназия г. Козельска',6,'projectpage.php?id=1',0),(10,'Школа с. Покровск',6,'projectpage.php?id=2',0);
...
INSERT INTO `news` VALUES (1,'Запущен редактор новостей','В разделе администрирования особо приближённым доступна теперь возможность добавлять, редактировать и удалять новости для правой колонки. Очень надеюсь, что эта возможность будет весьма востребована нашими драгоценными редакторами.','2018-04-22','admin',0),(2,'Группа ВКонтакте','Вконтакте теперь есть группа нашего Фонда: <a href=\"https://vk.com/club159379276\">Благотворительный фонд Амвросия Оптинского</a>','2018-05-17','admin',0),(3,'Ура, третья новость!','Скоро каникулы!!!','2018-05-19','admin',0);
...
INSERT INTO `users` VALUES (1,'admin','$2y$10$I3R6xFB.ttF5GA9KkE86R.k4Pv2PJwOJUswyYOZXoc2Y1BbJHQA8G',4,0);
