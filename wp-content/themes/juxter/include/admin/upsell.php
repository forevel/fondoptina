 ...
 * @return void
 */
function hoot_unload_upsell_section( $val ) {
	return false;
}
add_filter( 'hoot_customize_load_premiumsection', 'hoot_unload_upsell_section' );
...
function hoot_admin_enqueue_upsell_styles( $hook ) {
	if ( $hook == 'appearance_page_juxter-premium' )
