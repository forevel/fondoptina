	...
	<div <?php hybridextend_attr( 'header-part', 'supplementary', $class ); ?>>
		<div class="hgrid">
			<div class="hgrid-span-12">
				<?php
				$homeicon = apply_filters( 'hoot_menu_homeicon', '<div class="header-static-home"><a href="' . esc_url( home_url() ) . '" class="accent-typo"><i class="fa fa-home"></i></a></div>' );
...
function hoot_update_browser() {
	$notice = '<!--[if lte IE 9]><p class="chromeframe">' .
			  sprintf( __( 'You are using an outdated browser (IE 8 or before). For a better user experience, we recommend %1supgrading your browser today%2s or %3sinstalling Google Chrome Frame%4s', 'juxter' ), '<a href="http://browsehappy.com/">', '</a>', '<a href="http://www.google.com/chromeframe/?redirect=true">', '</a>' ) .
			  '</p><![endif]-->';
