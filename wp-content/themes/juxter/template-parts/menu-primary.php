...
if ( has_nav_menu( 'primary' ) ) : // Check if there's a menu assigned to the 'primary' location.
	...
	?>
	<h3 class="screen-reader-text"><?php _e( 'Primary Navigation Menu', 'juxter' ); ?></h3>
	<nav <?php hybridextend_attr( 'menu', 'primary' ); ?>>
		<div class="menu-toggle"><span class="menu-toggle-text"><?php _e( 'Menu', 'juxter' ); ?></span><i class="fa fa-bars"></i></div>
